	...
	<div class="mainbar">
		<div class="container">
			...
			<div class="col-lg-8 col-md-8 mt-5">
				...
				$ysql="SELECT * FROM `dis_electronic` WHERE dis_code='$id' AND dis_assets='$set' AND dis_status='1'";
						...
						else
						{
								...
								<div class="col-lg-6 col-md-6">
									...
									if(isset($_GET['id']) AND isset($_GET['set']))
									{
										...
										$tsql="SELECT dis_comcode FROM `dis_electronicdata` WHERE dis_code='$id' AND dis_pname='$set' AND dis_status='1'";
