			 ...
			 <div class="fistmenu">
				<p>Other Assets</p>
					<ul class="nav flex-column">
						...
						<?php
							$sql = "SELECT * FROM `dis_alldata` WHERE dis_pname NOT IN ('New Computer Set','Old Computer Set','Software') GROUP BY dis_pname";
						$res = mysqli_query($conn,$sql);
				...
				<table class="table table-bordered table-striped table-hover">
					...
					<tbody>
						...
						if(isset($_GET['add']))
						{
							...
							$add = $_GET['add'];
						$nums = 1;
						$mvql = "SELECT * FROM `dis_computer` WHERE dis_assets='$add'";
						...
						while($mrow = mysqli_fetch_array($mvres))
						{
							...
							<tr>
								...
								<td><a href="supply.php?id=<?php echo $mrow['dis_code'];?>&set=<?php echo $add;?>" class="suppbnt">Issue</a></td>
					...
					else
					{
						...
						while($mrow = mysqli_fetch_array($mvres))
						{
							...
							<td><?php echo $nums;?></td>
								...
								<td><a href="supply.php?id=<?php echo $mrow['dis_code'];?>&set=<?php echo 'New%20Computer%20Set';?>" class="suppbnt">Issue</a></td>
