			...
			<div class="fistmenu">
				<p>Transfer By Set</p>
					<ul class="nav flex-column">
						...
						<li class="navitem"><a href="transferset.php?add=Old Computer Set" class="navlink">Old Computer <i class="fa fa-angle-double-right"></i></a></li>
...
<div class="my-3">
			...
			<div class="table-wrapper-scroll-y my-custom-scrollbar">
				<table class="table table-bordered table-striped table-hover">
					...
					<tbody>
                        ...
                        $add =  "New Computer Set";
                        $nums = 1;
						$mvql = "SELECT * FROM `dis_alldata` WHERE dis_pname='New Computer Set' AND dis_pname ='$add' AND dis_status='2'";
						$mvres = mysqli_query($conn,$mvql);
						while($mrow = mysqli_fetch_array($mvres))
						{
							?>
			...
			<div class="form-inline clearfix mt-3">
					...
					<input type="submit" name="transeferset" class="btn btn-primary ml-4">
